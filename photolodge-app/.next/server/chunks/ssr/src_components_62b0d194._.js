...
"[project]/src/components/AllImagesGallery/AllImagesGallery.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AllImagesGallery() {
    ...
    const fetchImages = ()=>{
        const userId = localStorage.getItem("userId");
        if (!userId) return;
        fetch(`http://ec2-54-146-16-230.compute-1.amazonaws.com:8080/api/posts/user/${userId}?t=${Date.now()}`).then((res)=>res.json()).then((data)=>{
            setImages(data.data);
        });
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
//# sourceMappingURL=src_components_62b0d194._.js.map