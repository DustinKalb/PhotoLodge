...
"[project]/src/app/folder/[folderId]/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function FolderImagesPage() {
    const { folderId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useParams"])();
    ...
    const [dialogOpen, setDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch(`http://ec2-54-146-16-230.compute-1.amazonaws.com:8080/api/posts/folder/${folderId}`).then((res)=>res.json()).then((data)=>setImages(data.data || []));
    }, [
        folderId
    ]);
    ...
    const handleDelete = async ()=>{
        ...
        await fetch(`http://ec2-54-146-16-230.compute-1.amazonaws.com:8080/api/posts/${selectedImage._id}`, {
            method: "DELETE"
        });
    ...
    const handleDeleteFolder = async ()=>{
        await fetch(`http://ec2-54-146-16-230.compute-1.amazonaws.com:8080/api/folders/${folderId}`, {
            method: "DELETE"
        });
        router.push("/");
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "folder-page-root",
        children: [
...
//# sourceMappingURL=src_fa601ec0._.js.map